...
from layers import ISP_GIN_Degree
...
class GNN(torch.nn.Module):
    ...
    def __init__(self, input_dim, hidden_dim, output_dim, n_layers, batchnorm_dim, dropout_1, dropout_2):
        ...
        self.convs.append(ISP_GIN_Degree(input_dim, hidden_dim, batchnorm_dim, dropout_2))
        
        for _ in range(n_layers-1):
            self.convs.append(ISP_GIN_Degree(hidden_dim, hidden_dim, batchnorm_dim, dropout_2))
